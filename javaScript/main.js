...
document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    if (!validateForm(formData)) {
      showResponse('Please fill out all fields correctly.', 'error');
      return;
    }
...
// // Optional: Function to view all saved submissions (for testing)
...
// // Optional: Function to clear all saved submissions
